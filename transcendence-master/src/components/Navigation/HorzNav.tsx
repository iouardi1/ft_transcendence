...
export default function HorzNav(props: HorzNavProps) {
  const icon = {
    sun: (
      <svg
        className="mr-[8px] md:m-0"
        viewBox="0 0 24 24"
        fill="none"
    ...
    <div className="w-full max-h-[80px] m-0">
      <div className="bg-transparent w-full fixed top-0 left-0">
        <div className="flex h-[80px] w-[80%] md:w-full items-center">
          <div
            className={`h-[80px] min-w-[100px] md:bg-slate-50 md:dark:bg-[#272932] md:dark ${
              props.open ? "bg-slate-50 dark:bg-[#272932]" : ""
            }`}
          >
            <img
              src={logo}
              alt="logo"
              className="m-auto pl-[20px] pt-[10px] w-[65px] h-[65px] md:w-[70px] md:h-[70px] justify-center"
            />
          </div>
          ...
          <div
            ...
            className="text-3xl absolute right-8 top-6 cursor-pointer md:hidden dark:text-white"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
          ...
          <div className="flex w-full justify-between pl-[10px] md:pl-[60px] items-center">
            <div className="flex items-center w-[50%] md:w-[40%] h-[50px] bg-white dark:bg-[#272932] rounded-[15px]">
              ...
              >
                <path
                  fillRule="evenodd"
                  clipRule="evenodd"
                  d="M9.86955 0C15.3117 0 19.7383 4.42666 19.7383 9.86878C19.7383 12.4364 18.753 14.7781 17.1406 16.5356L20.3134 19.7018C20.6103 19.9987 20.6113 20.4791 20.3144 20.776C20.1664 20.926 19.9708 21 19.7762 21C19.5827 21 19.3881 20.926 19.2391 20.7781L16.028 17.5759C14.3389 18.9287 12.1971 19.7386 9.86955 19.7386C4.42743 19.7386 -0.000244141 15.3109 -0.000244141 9.86878C-0.000244141 4.42666 4.42743 0 9.86955 0ZM9.86955 1.52015C5.26554 1.52015 1.5199 5.26477 1.5199 9.86878C1.5199 14.4728 5.26554 18.2184 9.86955 18.2184C14.4726 18.2184 18.2182 14.4728 18.2182 9.86878C18.2182 5.26477 14.4726 1.52015 9.86955 1.52015Z"
                  fill="#8F8F8F"
                />
              </svg>
              <input
                ...
                id="search"
                placeholder="Search"
                className="bg-transparent w-full ml-[10px]"
              />
            </div>
            <div className="flex items-center md:w-[400px] justify-evenly w-full pr-[10px]">
              ...
              <div className="flex items-center justify-center bg-[#FEFEFF] dark:bg-[#272932] md:h-[50px] md:w-[50px] h-[40px] w-[40px] rounded-[10px] md:rounded-[15px] md-rounded-[20px]">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="21"
                  height="25"
