      ...
      return (
        <div className=" w-[70%] max-h-[60%] m-[15px]">
          <div className="w-full h-full flex">
            ...
            />
            <div
              className="p-[10px] ml-[15px] max-w-[60%] w-fit h-fit bg-[#EEEEFF] rounded-[25px] dark:bg-[#1A1C26] text-left text-black dark:text-white text-clip overflow-hidden"
              style={{
                fontFamily: "poppins",
                fontSize: "14px",
                fontStyle: "normal",
