...
function BannedList (props:any)
{
  ...
  console.log("oprps in banned list", props);
        ...
        const fetchData = async () => {
          try {
            ...
            if (response.status === 200) {
              ...
              //useHistory to redirect the client to an error page
    ...
    console.log("oprps in banned list", banData);
    if (banData)
    {
        return (
            <div
            ...
            >
                ...
                {
                    banData.map((users) => (
                        < BannedUser key={users.id} dataState={users} socketId={socket} roomId={Number(receivedData)} userId={props.userId}/>
                ))
                }
