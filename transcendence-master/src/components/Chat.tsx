...
const DMComp = () =>
{
  ...
  return (
    <div  className='icon w-[90px] h-[40px] ml-[-120px] mb-[15px]'>
      ...
      <div className='date w-[90px] mt-[-30px] ml-[180px]' style={{color: '#7C7C7C', fontFamily: 'Roboto', fontSize: '13px', fontStyle: 'normal', fontWeight: 300, lineHeight: 'normal', letterSpacing: '0.13px' }}>
...
const Chat = () => {
  return (
    ...
    ml-[2px] mr-[2px] mb-[10px] h-full w-full flex flex-wrap 100vh gap-[0px]">
      ...
      ml-[-10px] mr-[15px] my-[15px] w-[50%] h-[88%] rounded-[25px] flex-2 flex-shrink-0 border-solid border-[#FFFFFF] bg-[#FFFFFF]  shadow-none dark:border-[#272932] dark:bg-[#272932]">
      </div>
    </div> 
  )
}
