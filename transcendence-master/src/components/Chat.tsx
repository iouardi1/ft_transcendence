    ...
    <div className="icon w-full h-[40px] mb-[15px] flex-wrap">
      <div className="icon w-full h-[40px] mb-[15px] flex justify-between">
        <div className="w-[70%] h-full ">
          ...
          <div
            className="groupMsg text-black dark:text-white w-[95px] mt-[-40px] ml-[45px]"
            style={{
              fontFamily: "Roboto",
              fontSize: "13px",
              fontStyle: "normal",
    ...
    <div className="w-full h-full p-[20px] flex">
      <div className="w-[100%] flex flex-wrap">
        ...
        <div className="w-full h-[40px] mt-[-42px] ml-[55px] justify-around">
          <div
            className=" text-black dark:text-white w-full h-[50%]"
            style={{
              fontFamily: "Roboto",
              fontSize: "20px",
              fontStyle: "normal",
...
const Chat = () => {
  return (
    ...
    >
      ...
      >
        <div
          className="lg:w-[90%] lg:h-[32%] lg:rounded-[25px] lg:border-solid lg:flex-wrap lg:border-[#FFFFFF] lg:bg-[#FFFFFF]  lg:shadow-none lg:dark:border-[#272932] lg:dark:bg-[#272932]
        w-[90%] h-[32%] rounded-[25px] border-solid flex-wrap border-[#FFFFFF] bg-[#FFFFFF]  shadow-none dark:border-[#272932] dark:bg-[#272932]"
        >
          <div
            className="group ml-[25px] text-black dark:text-white"
            style={{
              fontFamily: "Roboto",
              fontSize: "30px",
              fontStyle: "normal",
        ...
        <div
          className="lg:mb-[5px] lg:mt-[10px] lg:w-[90%] lg:h-[55%] lg:rounded-[25px]  lg:border-solid lg:flex-wrap lg:border-[#FFFFFF] lg:bg-[#FFFFFF]  lg:shadow-none lg:dark:border-[#272932] lg:dark:bg-[#272932]
        ...
        >
          <div
            className="dms ml-[25px] text-black dark:text-white"
            style={{
              fontFamily: "Roboto",
              fontSize: "30px",
              fontStyle: "normal",
